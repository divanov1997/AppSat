 ...
 * @throws java.io.IOException */
  ...
  public final void driver2() throws IOException
  {
	   ...
	   SDP4InvalidNumException, IOException
  {
    ...
    /* Read lines 1 and 2. */
    //Up until here, all it does is find the tle sing the name, what I already did before.
    ReadNorad12(theFile);
...
2 NNNNN NNN.NNNN NNN.NNNN NNNNNNN NNN.NNNN NNN.NNNN NN.NNNNNNNNNNNNNN
 ...
 /**
  * ReadNorad12 modified for my app 
  * The method no longer requires a file, but 2 strings, the two lines of tle.
  */
  public final void ModifiedReadNorad12(String Line1, String Line2)
		    throws SDP4NoLineOneException, SDP4InvalidNumException, IOException
		  {
		    String theLine;
		    double year, day, t, A1, DEL1, AO, DELO, XNODP;
